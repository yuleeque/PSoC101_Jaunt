// ======================================================================
// 06_BasicCounter.v generated from TopDesign.cysch
// 06/01/2025 at 19:05
...
module top ;
	...
	wire [0:0] tmpOE__Pin_RED2_net;
	wire [0:0] tmpFB_0__Pin_RED2_net;
	wire [0:0] tmpIO_0__Pin_RED2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_RED2_net;
	electrical [0:0] tmpSIOVREF__Pin_RED2_net;

	cy_psoc3_pins_v1_10
		#(.id("b49e15d4-b9b9-4b45-9ded-7bba425108f0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_RED2
		 (.oe(tmpOE__Pin_RED2_net),
		  .y({Net_34[1]}),
		  .fb({tmpFB_0__Pin_RED2_net[0:0]}),
		  .io({tmpIO_0__Pin_RED2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RED2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_RED2_net[0:0]}),
		  .annotation({Net_33}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_RED2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 RED2 (
        .connect({
            Net_36,
            Net_37
        })
    );
    defparam RED2.comp_name = "LED_v1_0";
    defparam RED2.port_names = "A, K";
    defparam RED2.width = 2;
