...
#define Pin_SW2_Int_INTC_VECTOR            ((reg16 *) Pin_SW2_Int__INTC_VECT)
...
#define Pin_SW2_Int_INTC_SET_EN            ((reg8 *) Pin_SW2_Int__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the Pin_SW2_Int interrupt. */
#define Pin_SW2_Int_INTC_CLR_EN            ((reg8 *) Pin_SW2_Int__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the Pin_SW2_Int interrupt state to pending. */
#define Pin_SW2_Int_INTC_SET_PD            ((reg8 *) Pin_SW2_Int__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the Pin_SW2_Int interrupt. */
#define Pin_SW2_Int_INTC_CLR_PD            ((reg8 *) Pin_SW2_Int__INTC_CLR_PD_REG)
